...
export const env = {
  ...
  geminiRetryCount: Math.max(0, Number(process.env.GEMINI_RETRY_COUNT ?? 2)),
  geminiRetryBaseDelayMs: Math.max(100, Number(process.env.GEMINI_RETRY_BASE_DELAY_MS ?? 1000)),
